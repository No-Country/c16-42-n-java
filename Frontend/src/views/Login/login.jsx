        ...
        >
          <div className={styles.sContainer}>
            <div className="modal-dialog w-50">
              <div className={`${styles.m} modal-content bg-opacity-30 form-control`} id="m">
              <div
                className="modal-content bg-opacity-30 form-control p-0 border border-0"
                ...
                <div className={styles.modalContent}>
                  <form>
                    ...
                    >
                      ...
                      <div className={styles.link} style={{ width: "100%" }}>
                        <button
                          type="submit"
